...
function tutor4_column(source, worked, route) {
  ...
  worked.series[0] = {
    name: "人数",
    data: [source.level_senior_count, source.level_one_count, source.level_two_count, source.level_three_count, source.level_other_count]
  };
...
function All1stu_Pie(source, worked, route, Highcharts) {
  ...
  worked.tooltip = {
    ...
    pointFormatter: function () {
      return this.name + ":<b>" + this.y + "名，百分比：" + ((this.y / source.total) * 100).toFixed(2) + "%</b><br/>"
    }
  };
  return worked;
}
...
function All1GBtutor_bar3(source, worked, route, Highcharts) {
  ...
  worked.series[0] = {
    name: "人数",
    data: [source.level_senior_count, source.level_one_count, source.level_two_count, source.level_three_count, source.level_js_count, source.level_gjjs_count, source.level_other_count]
  };
